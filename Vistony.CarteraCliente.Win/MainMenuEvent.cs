   ...
   public  class MainMenuEvent
    {
        ...
        public void SB1_Application_MainMenuEvent(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                if (pVal.BeforeAction)
                {
                    switch (pVal.MenuUID)
                    {
                        #region Modulos/Ventas 

                        case AddonMenuItem.Carga_Masiva:
                            {
                                OnShowCargaMasiva();
                            }
                            break;
       ...
       private void OnShowCargaMasiva()
        {
            try
            {
              wzdCargaMasiva wizard = new wzdCargaMasiva();
              wizard.Show();
            }
            catch (Exception ex)
            {
        ...
        private void OnShowCambioCartera()
        {
            try
            {
                wzdCartera wizard = new wzdCartera();
                wizard.Show();
            }
            catch (Exception ex)
            {
